...
<!-- Content Header (Page header) -->
    ...
    @include('templates/feedback')
      ...
      <div class="box">
        ...
        <div class="box-body">
        <form action='{{ empty($result) ? url("siswa/add") : url("siswa/$result->nis/edit") }}' 
        ...
        <div class="form-group">
         ...
         <div class="form-group">
          ...
          <div class="col-sm-10">
              ...
              placeholder="Masukkan Alamat Lengkap"> {!! @$result->alamat !!} </textarea>
          </div>
         </div> 
          ...
          <div class="col-sm-10">
              ...
              placeholder="Masukkan Nomor Telepon" value="{{ @$result->no_telp}}" />
          </div>
         </div> 
